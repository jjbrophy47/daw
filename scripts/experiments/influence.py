...
def main(args):
    ...
    explainer = InfluenceEstimator(method=args.method, params={'k': args.k}, logger=logger)
    ...
    # sorted_train_idxs = np.argsort(influence, axis=1)[::-1]
    # remove_fracs = [0.0, 0.01, 0.025, 0.05, 0.1, 0.15, 0.2]
    # for i in range(influence.shape[1]):
